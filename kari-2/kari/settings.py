...
MEDIA_ROOT = '/home/buptacm/oj/media/'
...
STATIC_ROOT = '/home/buptacm/oj/static/'
...
TEMPLATE_DIRS = (
    '/home/buptacm/oj/kari/templates',
...
INTERNAL_IPS = ('127.0.0.1', '10.205.20.146', '10.105.243.7','10.105.240.128','::ffff:10.205.10.234','10.205.10.234', '10.105.240.51')
...
LOGGING = {
    ...
    'handlers': {
        'default': {
            ...
            'filename': '/home/buptacm/oj/log/oj_info.log',
        ...
        'error_file': {
            'level': 'ERROR',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': '/home/buptacm/oj/log/oj_error.log',
            'maxBytes': 1024*1024*5,
            'backupCount': 5,
            'formatter':'standard',
        },
