...
class Const():
    ...
    PROBLEM_DATA_PATH = "/home/buptacm/oj/media/data/"
    # PROBLEM_STANDARD_CODE_PATH = "/home/buptacm/oj/media/standard"
    PREVIEW_TESTDATA_MAXSIZE = 1024

    # Submission Const
    SUBMISSION_CODE_PATH = '/home/buptacm/oj/media/submission/'
    GENERAL_SUBMISSION_CODE_PATH = '/home/buptacm/oj/media/general_submission/'
    SUBMISSION_TMP_PATH = '/home/buptacm/oj/media/sub_temp/'
    STATUS_PER_PAGE = 50
    STATUS = (
            ( 'PD', 'Pending'),
            ( 'SE', 'System Error'),
    ...
    CHEAT_PER_PAGE = 25
    CHEAT_DEFAULT_THRESHOLD = 80

    # Judger
    JUDGER_NAME = "kAri Apple(alpha)"

    # Board
    STATUS_NO_USE = set(['Pending', 'Rejudging', 'Compiling', 'System Error'])
